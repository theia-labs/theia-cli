...
class GroupSubscriptionRules {
    ...
    async createGroupSubscriptionRule () {
        ...
        let createdGroupRule = await this.resourceSendData.sendDataPost('/api/group_subscription_rules', JSON.stringify(groupRules));
    ...
    async editGroupSubscriptionRule () {
        ...
        if (groupRules) {
            ...
            let groupNewRules = await this.resourceSendData.sendDataPut('/api/group_subscription_rules/' + groupRulesId, JSON.stringify(newGroupRules));
