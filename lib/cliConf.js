...
const { CustomUserAttributes } = require('./modules/customUserAttributes');
...
const modules = {
    ...
    'custom-user-attributes': {
        ...
        method: (options, resourceFinder) =>
            new CustomUserAttributes(resourceFinder).getCustomUserAttributes(options),
        auth: true,
    },
    ...
    'create-group-subscription-rules': {
        arguments: [...authArguments, 'groupRules'],
    ...
    'edit-group-subscription-rules': {
        arguments: [...authArguments, 'groupRuleId', 'rules'],
        description: 'return all groups affiliate rules',
        method: (options, resourceFinder, resourceSendData, resourceRemover) =>
